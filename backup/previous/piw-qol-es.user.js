...
(function() {
    ...
    function injectDexEnhancements() {
        ...
        bar.innerHTML = `
            ...
            <button class="dex-fbtn" data-filter="caught" type="button">✓ Capturados</button>
            <button class="dex-fbtn" data-filter="notcaught" type="button">✗ No capturados</button>
            <button class="dex-fbtn" data-filter="claimable" type="button">🎁 Para reclamar</button>
    ...
    async function enhanceCaptureLog() {
        ...
        captureLogEnhancementPromise = gameApiRequest(`/api/game/capture-log?filter=${filter}`)
            ...
            .catch(error => console.error('Error al cargar la calidad del registro de capturas:', error))
